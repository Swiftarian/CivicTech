...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    if (!loading && (!isAuthenticated || (user?.role !== 'admin' && user?.role !== 'volunteer'))) {
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/admin/news">
                <Button variant="secondary" size="sm">最新消息</Button>
              </Link>
              <Link href="/admin/gallery">
                <Button variant="secondary" size="sm">服務花絮</Button>
              </Link>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>按分類管理導覽館志工和送餐志工</CardDescription>
                  </div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>編輯首頁的文字內容和輪播照片</CardDescription>
                  </div>
